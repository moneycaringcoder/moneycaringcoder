...
- [herdr-collide](https://github.com/moneycaringcoder/herdr-collide) — cross-worktree collision warnings for Herdr agents
- [herdr-pulse](https://github.com/moneycaringcoder/herdr-pulse) — workspace activity sparklines for Herdr
- [herdr-redact](https://github.com/moneycaringcoder/herdr-redact) — credential leak warnings for Herdr panes
